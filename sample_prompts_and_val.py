...
def parse_args():
    ...
    parser.add_argument("--prompts_save_path", default="/net/nfs.cirrascale/allennlp/willm/ngram-copying/data/iid/prompts.jsonl")
    parser.add_argument("--val_save_path", default="/net/nfs.cirrascale/allennlp/willm/ngram-copying/data/iid/val.jsonl")
